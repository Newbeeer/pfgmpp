    ...
    for ckpt_dir in stats:
        ...
        for alpha in alpha_list:
            ...
            if seeds[-1] > 49999 and seeds[-1] <= 99999:
                temp_dir = os.path.join(outdir, f'ckpt_2_{ckpt_num:06d}_{alpha}')
            elif seeds[-1] > 99999:
                temp_dir = os.path.join(outdir, f'ckpt_3_{ckpt_num:06d}_{alpha}')
            else:
                temp_dir = os.path.join(outdir, f'ckpt_{ckpt_num:06d}_{alpha}')
